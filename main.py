...
# ==============================================================================
# --- گرفتن محصولات هر دسته با کنترل خطا و @retry (تغییر به scraping HTML بر اساس شرط شما) ---
# ==============================================================================
        ...
        try:
            ...
            for block in product_blocks:
                try:
                    ...
                    if bell_icon:
                        # متن کامل یا sibling بعدی را چک کن (فرض بر متن کامل عنصر یا بعدی)
                        stock_text = bell_icon.text.strip() or bell_icon.next_sibling.text.strip() if bell_icon.next_sibling else ""
                        if stock_text == "0 عدد در انبار باقیست":
                            logger.debug(f"      - محصول skip شد: ناموجود (متن: {stock_text}).")
                            continue
                    # اگر bell نبود یا متن دیگری بود، موجود است
                    ...
                    if not name:
                        ...
                        continue
                    stock = 1  # فرض بر موجودی 1، چون در HTML مشخص نیست
