...
# این الگو با ?page= کار میکند چون روش دیگر در لاگ‌ها ناموفق بود
    ...
    try:
        ...
        if existing:
            ...
            if res.status_code == 201:
                ...
                print(f"   ❌ خطا در ایجاد '{data['name']}'. Status: {res.status_code}, Response: {res.text[:200]}")
    except Exception as e:
...
def main():
    ...
    # ID دسته‌بندی‌هایی که می‌خواهید محصولاتشان منتقل شود را اینجا وارد کنید
