...
def get_product_detail(session, cat_id, product_id):
    """جزئیات محصول را از صفحه جزئیات استخراج می‌کند و HTML را ذخیره می‌کند."""
